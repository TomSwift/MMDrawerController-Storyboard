#
#  Be sure to run `pod spec lint MMDrawerController-Storyboard.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/TomSwift/MMDrawerController-Storyboard.git", :commit => "3accdc959e9a625da055db42f6e7b72c441d828c" }
